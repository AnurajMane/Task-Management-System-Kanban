...
function LoginLeftPanel() {
  return (
    <div className="relative hidden lg:flex lg:w-1/2 overflow-hidden bg-zinc-300 p-16 text-zinc-900 border-r border-zinc-200/80 justify-center items-center min-h-screen">
      ...
      <div className="relative flex h-full w-full flex-col justify-between z-10">
        ...
        {/* High-Fidelity Mock Kanban Board (Light Glassmorphism) */}
        <div className="my-auto w-full max-w-xl rounded-2xl border border-zinc-200/80 bg-white/70 p-6 backdrop-blur-xl shadow-xl shadow-zinc-200/40">
          ...
          <div className="grid grid-cols-3 gap-4">
            ...
            {/* Column: To Do */}
            <div className="rounded-xl bg-zinc-50/50 border border-zinc-200/50 p-3">
              ...
              <div className="space-y-2.5">
                <div className="h-16 rounded-lg bg-white border border-zinc-200/60 p-2 flex flex-col justify-between shadow-sm">
            ...
            <div className="rounded-xl bg-zinc-50/50 border border-zinc-200/50 p-3">
              ...
              <div className="space-y-2.5">
                <div className="h-16 rounded-lg bg-white border border-indigo-200 shadow-sm shadow-indigo-100/40 p-2 flex flex-col justify-between relative overflow-hidden">
            ...
            <div className="rounded-xl bg-zinc-50/50 border border-zinc-200/50 p-3">
              ...
              <div className="space-y-2.5">
                <div className="h-16 rounded-lg bg-zinc-100/50 border border-zinc-200/40 opacity-60 p-2 flex flex-col justify-between">
        ...
        <div className="mt-8">
          <h2 className="max-w-md text-3xl font-bold tracking-tight leading-tight text-zinc-900">
